...
docker build -f Dockerfile.fpm \
  --build-arg PHP_VERSION=8.1.0RC4 \
  -t mgdteam/php:8.1.0RC4-fpm-nginx .

docker build -f Dockerfile.cli \
  --build-arg PHP_VERSION=8.1.0RC4 \
  -t mgdteam/php:8.1.0RC4-cli .
...
docker push mgdteam/php:8.1.0RC4-fpm-nginx
docker push mgdteam/php:8.1.0RC4-cli
